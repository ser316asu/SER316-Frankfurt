...
public class TasksList extends JList {
    ...
    public void update(NoteList nl) {
        if (_type == ALL)
            tasks = (Vector) nl.getAllNotes();
        else
            tasks = (Vector) nl.getMarkedNotes();
